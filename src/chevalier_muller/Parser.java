...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Feb 17 16:03:33 CET 2014
  */
public class Parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    ...
    "\010\002\010\004\005\005\006\001\002\000\004\006\014" +
    "\001\002\000\004\006\012\001\002\000\004\011\011\001" +
    "\002\000\004\002\000\001\002\000\010\002\uffff\004\uffff" +
    "\005\uffff\001\002\000\004\011\013\001\002\000\004\011" +
    "\ufffd\001\002\000\004\011\015\001\002\000\004\011\ufffe" +
    "\001\002" });
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP_act_num)
		...
		Object n = (Object)((java_cup.runtime.Symbol) CUP_stack.elementAt(CUP_top-1)).value;
		 System.out.println(Struct.getStruct((String) n).toString()); 
          ...
          case 8: // assignement ::= NAME POINT NAME EQUAL NAME TERM 
            {
              Object RESULT =null;
		Object structName = (Object)((java_cup.runtime.Symbol) CUP_stack.elementAt(CUP_top-5)).value;
		...
		Object val = (Object)((java_cup.runtime.Symbol) CUP_stack.elementAt(CUP_top-1)).value;
		 Struct.getStruct((String) structName).put((String) key, (String) val); 
              CUP_result = getSymbolFactory().newSymbol("assignement",4, RESULT);
            }
          return CUP_result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // assignement ::= NAME POINT NAME EQUAL DOUBLE_QUOTE NAME DOUBLE_QUOTE TERM 
            {
              Object RESULT =null;
		Object structName = (Object)((java_cup.runtime.Symbol) CUP_stack.elementAt(CUP_top-7)).value;
		...
		Object val = (Object)((java_cup.runtime.Symbol) CUP_stack.elementAt(CUP_top-2)).value;
		 Struct.getStruct((String) structName).put((String) key, (String) val); 
          ...
          case 6: // structure ::= NAME EQUAL NEW NAME TERM 
            {
              Object RESULT =null;
		Object structName = (Object)((java_cup.runtime.Symbol) CUP_stack.elementAt(CUP_top-4)).value;
		Object structModelName = (Object)((java_cup.runtime.Symbol) CUP_stack.elementAt(CUP_top-1)).value;
		 Struct.createStruct((String) structName, (String) structModelName); 
              CUP_result = getSymbolFactory().newSymbol("structure",3, RESULT);
            }
          return CUP_result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // structure_def ::= STRUCT NAME data_defs END_STRUCT 
            {
              Object RESULT =null;
		Object structModelName = (Object)((java_cup.runtime.Symbol) CUP_stack.elementAt(CUP_top-2)).value;
		 System.out.println("STRUCT MODEL: " + (String) structModelName); createStructModel((String) structModelName); 
          ...
          case 4: // data_def ::= PTR NAME TERM 
            {
              Object RESULT =null;
		Object pntr = (Object)((java_cup.runtime.Symbol) CUP_stack.elementAt(CUP_top-1)).value;
		 getStructModel().putPointer((String) pntr); 
          ...
          case 3: // data_def ::= VAR NAME TERM 
            {
              Object RESULT =null;
		Object val = (Object)((java_cup.runtime.Symbol) CUP_stack.elementAt(CUP_top-1)).value;
		 getStructModel().putValue((String) val); 
              CUP_result = getSymbolFactory().newSymbol("data_def",2, RESULT);
            }
          return CUP_result;
